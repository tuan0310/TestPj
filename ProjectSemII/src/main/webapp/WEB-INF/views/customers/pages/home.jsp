            ...
            <div class="row">
                <div class="col-xl-6 col-lg-6">
                    <div class="welcome_thumb">
                        <div class="thumb_1">
                            <img src="<c:url value="assets"/>/customers/img/about/1.png" alt="">
                        </div>
                        <div class="thumb_2">
                            <img src="<c:url value="assets"/>/customers/img/about/2.png" alt="">
                        </div>
                    </div>
                </div>
                <div class="col-xl-6 col-lg-6">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-xl-4 col-md-6 col-lg-4">
                    <div class="single_department">
                        <div class="department_thumb">
                            <img src="<c:url value="assets"/>/customers/img/department/1.png" alt="">
                        </div>
                ...
                <div class="col-xl-4 col-md-6 col-lg-4">
                    <div class="single_department">
                        <div class="department_thumb">
                            <img src="<c:url value="assets"/>/customers/img/department/2.png" alt="">
                        </div>
                        <div class="department_content">
                ...
                <div class="col-xl-4 col-md-6 col-lg-4">
                    <div class="single_department">
                        <div class="department_thumb">
                            <img src="<c:url value="assets"/>/customers/img/department/3.png" alt="">
                        </div>
                        <div class="department_content">
                ...
                <div class="col-xl-4 col-md-6 col-lg-4">
                    <div class="single_department">
                        <div class="department_thumb">
                            <img src="<c:url value="assets"/>/customers/img/department/4.png" alt="">
                        </div>
                        <div class="department_content">
                ...
                <div class="col-xl-4 col-md-6 col-lg-4">
                    <div class="single_department">
                        <div class="department_thumb">
                            <img src="<c:url value="assets"/>/customers/img/department/5.png" alt="">
                        </div>
                        <div class="department_content">
                ...
                <div class="col-xl-4 col-md-6 col-lg-4">
                    <div class="single_department">
                        <div class="department_thumb">
                            <img src="<c:url value="assets"/>/customers/img/department/6.png" alt="">
                        </div>
                        <div class="department_content">
                                    ...
                                    <div class="row align-items-center">
                                            ...
                                            <div class="col-xl-6 col-md-6">
                                                <div class="business_thumb">
                                                    <img src="<c:url value="assets"/>/customers/img/about/business.png" alt="">
                                                </div>
                                            </div>
                                        </div>
                            </div>
                    ...
                    <div class="expert_active owl-carousel">
                        <div class="single_expert">
                            <div class="expert_thumb">
                                <img src="<c:url value="assets"/>/customers/img/experts/1.png" alt="">
                            </div>
                        ...
                        <div class="single_expert">
                            <div class="expert_thumb">
                                <img src="<c:url value="assets"/>/customers/img/experts/2.png" alt="">
                            </div>
                            <div class="experts_name text-center">
                                <h3>Mirazul Alom</h3>
                                <span>Neurologist</span>
                        ...
                        <div class="single_expert">
                            <div class="expert_thumb">
                                <img src="<c:url value="assets"/>/customers/img/experts/3.png" alt="">
                            </div>
                            <div class="experts_name text-center">
                                <h3>Mirazul Alom</h3>
                                <span>Neurologist</span>
                        ...
                        <div class="single_expert">
                            <div class="expert_thumb">
                                <img src="<c:url value="assets"/>/customers/img/experts/4.png" alt="">
                            </div>
                            <div class="experts_name text-center">
                                <h3>Mirazul Alom</h3>
                                <span>Neurologist</span>
